...
const injectParamsToQuery = (sqlText = '', staticCtx /*:{[string]: string}*/, argHash = {}) => {
    const params = []
...
const sqlTextToQueryFn = (runDbQuery, ctx /*:StoreContext*/, sqlText /*:string*/) => (argHash = {}) => {
...
const loadQueries = (pathToDir = '') /*:{[string]: string}*/ => {
    const queryMap = {}
